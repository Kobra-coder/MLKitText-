...
public class MainActivity extends AppCompatActivity {
    ...
    private void processText(FirebaseVisionText mVisionText){
        ...
        for (FirebaseVisionText.TextBlock mBlock_i: mVisionText.getTextBlocks()) {
            ...
            if (mText.equals("PEEPAT")) {

                mTextView.setTextSize(24);
                mTextView.setText("Это реферат");
                mTextView.setTextColor(getColor(R.color.black));
            } else if (mText.equals("PEDEPAT")) {
                ...
                mTextView.setText("Это реферат");
                mTextView.setTextColor(getColor(R.color.black));
            } else if (mText.equals("PEOEPAT")) {

                mTextView.setTextSize(24);
                mTextView.setText("Это реферат");
                mTextView.setTextColor(getColor(R.color.black));
            } else if (mText.equals("PEPAT")) {
                mTextView.setTextSize(24);
                mTextView.setText("Это реферат");
                mTextView.setTextColor(getColor(R.color.black));
            } else if (mText.equals("PEPAY")) {
